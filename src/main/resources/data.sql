...
values
 (9,
 'aced0005737200226f72672e737072696e676672616d65776f726b2e646174612e67656f2e506f696e7431b9e90ef11a4006020002440001784400017978704023000000000000404bfa1cac083127', now(), now(), false, 'ONLINE',
'cf3a3bbe331c3950d16a8e9917c5bb8340e7c0ef917da25d4a96f92d074bce05', 'bhanu');

-- Create 3 cars

insert into car (CONVERTIBLE , DATE_CREATED , DATE_UPDATED, DELETED , ENGINE_TYPE , LICENSE_PLATE , RATING , SEAT_COUNT )
values
(1, now(), now(), false, 'gas', 'KA-05-JS-4741', 99,4),
(0, now(), now(),false, 'electric', 'KA-05-JS-4748',11,6),
(0, now(), now(),false, 'gas', 'KA-05-JS-4746',12,5);

-- Create 1 car driver mapping

insert into CAR_DRIVER_MAPPER (ACTIVE, CAR_ID, DATE_CREATED, DRIVER_ID )
values
(1,1,now(),4);